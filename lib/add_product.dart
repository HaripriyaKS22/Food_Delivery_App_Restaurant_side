...
void RegisterUserData(
  ...
  try {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('$api/HOMFOO-restaurant/HOMFOO-add-products/'));
              ...
              child: TextButton(
                onPressed: () async {
                 token = await gettokenFromPrefs();
                  RegisterUserData(name.text,price.text,selectedImage,selectedImage2,selectedImage3,Offers.text,description.text,selectedCategoryId,scaffoldContext,token!);
